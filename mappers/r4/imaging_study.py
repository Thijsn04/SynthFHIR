"""R4 ImagingStudy resource mapper. Spec: https://hl7.org/fhir/R4/imagingstudy.html"""
import uuid
        ...
        "series": [
            {
                "uid": series_uid,
                "number": 1,
                "modality": {"system": _DCM, "code": study["modality_code"], "display": study["modality_display"]},
                "numberOfInstances": 1,
                "bodySite": {"system": _SNOMED, "code": study["bodysite_code"], "display": study["bodysite_display"]},
                "instance": [
