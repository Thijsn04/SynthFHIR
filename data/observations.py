...
OBSERVATIONS: dict[str, ObservationDef] = {
    ...
    for o in [
        ...
        ObservationDef(
            ...
            abnormal_range=(0.01, 0.39),  # hyperthyroid (low TSH); hypothyroid uses elevated range
            low_threshold=0.4,
            high_threshold=4.5,
            decimal_places=2,
        ),
        ObservationDef(
            ...
            ucum_code="m[IU]/L",
            normal_range=(0.4, 4.5),
            abnormal_range=(5.0, 50.0),   # hypothyroid (high TSH)
            low_threshold=0.4,
            high_threshold=4.5,
            decimal_places=2,
        ),
        ...
        ObservationDef(
            ...
            unit="g/dL",
            ucum_code="g/dL",
            normal_range=(12.0, 17.5),   # combined male/female range
            abnormal_range=(7.0, 11.9),
            low_threshold=12.0,
            high_threshold=None,
            decimal_places=1,
        ),
        ObservationDef(
            ...
            abnormal_range=(125.0, 135.0),
            low_threshold=136.0,
            high_threshold=145.0,
            decimal_places=0,
        ),
        ObservationDef(
            key="platelet_count",
            ...
            unit="10*3/uL",
            ucum_code="10*3/uL",
            normal_range=(150.0, 350.0),
            abnormal_range=(50.0, 149.0),
            low_threshold=150.0,
        ...
        ObservationDef(
            ...
            unit="mg/g",
            ucum_code="mg/g",
            normal_range=(0.0, 29.9),
            abnormal_range=(30.0, 3000.0),
            low_threshold=None,
            high_threshold=29.9,
            decimal_places=1,
        ),
